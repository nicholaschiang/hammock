    ...
    >
      <div className='rounded p-10 bg-white' style={{ width: '600px' }}>
        ...
        <div className='pb-4' style={{ fontSize: '14px' }}>
          ...
          <p className='text'>
            The Newsletter Reader integrates with your Gmail so there’s no need
            for a new email address or subscribing to all the newsletters again.
          </p>
        </div>
        <div className='pb-4' style={{ fontSize: '14px' }}>
          <p className='font-bold'>Your data is safe</p>
          <p className='text'>
            We’re are here to help you better consume your newsletters, nothing
            else. Your emails stay 100% private and secure. Our use of
