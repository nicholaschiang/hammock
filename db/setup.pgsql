...
$$
  ...
  create table subscriptions (
    ...
    "newsletter" email references newsletters(email) on delete cascade on update cascade not null,
    "category" category not null default 'other',
    "favorite" boolean not null default false,
    primary key ("user", "newsletter")
  );
  create table messages (
    ...
    foreign key ("user", "newsletter") references subscriptions("user", "newsletter") on delete cascade on update cascade
  );
