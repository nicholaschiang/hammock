export function hasWhitelistDomain(email: string) {
...
export const whitelist: Record<string, true | { asset_url: string }> = {
  '#coolshit': true,
  ...
  'being patient': true,
  'benedict evans': { asset_url: '/assets/benedictevans.jpg' },
  ...
  'quartz africa weekly brief': { asset_url: '/assets/quartz.jpg ' },
  'quartz daily brief': { asset_url: '/assets/quartz.jpg ' },
  'quartz daily obsession': { asset_url: '/assets/quartz.jpg ' },
  ...
  'the hustle': true,
  'the information': { asset_url: '/assets/theinformation.png' },
  'the interface': true,
  'the jacuzzi': true,
  ...
  'hugo amsellem': true,
  'jessica lessin': { asset_url: '/assets/theinformation.png' },
};
